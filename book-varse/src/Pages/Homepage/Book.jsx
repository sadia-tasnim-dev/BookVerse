...
export const Book = ({ image, bookName, author, rating, category }) => {
  return (
    <div className="bg-blue-50 rounded-t-full flex flex-col shadow-[5px_5px_20px_2px_#e6e8eb]">
      <div className="px-5 pt-[110px] relative">
        <img className="h-36 absolute -top-14 right-24" src={image} />
        ...
        <div className="flex items-center mt-3 justify-between">
          ...
          <button className="flex items-center gap-2 w-fit bg-gradient-banner text-white font-semibold px-2  rounded-2xl ">
            View details
          </button>
        </div>
      </div>
